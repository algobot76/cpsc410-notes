...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item \sout{Design and run user studies to evaluate design questions empirically.}
        \item \sout{Reflect on user feedback to identify potential root causes of any difficulties.}
        \item \sout{Address these root problems with appropriate redesign ideas.}
